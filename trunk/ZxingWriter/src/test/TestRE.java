...
//     @Test
    public void matchtest() {
        ...
        log2("length: " + searchRegex.getProgram().getInstructions().length);
        for (int i = 0; i < searchRegex.getProgram().getInstructions().length; i++) {
            log2(" " + searchRegex.getProgram().getInstructions()[i]);
        }
        log("");
